...
#ifndef __CH32F10x_USBHD_HOST_H
#define __CH32F10x_USBHD_HOST_H
...
extern __attribute__((aligned(4))) uint8_t  USBHD_RX_Buf[ MAX_PACKET_SIZE ];
extern __attribute__((aligned(4))) uint8_t  USBHD_TX_Buf[ MAX_PACKET_SIZE ];
