...
_0x200000C:
	LDI  R30,LOW(0)
_0x200000D:
	STS  _backlight_S1000001000,R30
	LDI  R30,LOW(63)
	ST   -Y,R30
	LDI  R30,LOW(_backlight_S1000001000)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _I2C_WRITESEQ
	RJMP _0x2020002
_0x200000B:
	LDS  R30,_backlight_S1000001000
	LDD  R26,Y+6
	OR   R30,R26
	STD  Y+6,R30
	STD  Y+1,R30
