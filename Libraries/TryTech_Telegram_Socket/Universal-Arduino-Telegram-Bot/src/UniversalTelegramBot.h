...
public:
  ...
  bool deleteMessage(String chat_id, String message_id);
  bool editMessageText(String chat_id, String message_id, String text, String parse_mode = "");
  ...
  bool editPostMessageText(JsonObject &payload); //TT
  bool deletePostMessage(JsonObject &payload);
