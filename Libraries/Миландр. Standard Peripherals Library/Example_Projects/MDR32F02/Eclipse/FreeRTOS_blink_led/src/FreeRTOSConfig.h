...
#define configMTIME_BASE_ADDRESS 	( MDR_CLINT_TIMER )
#define configMTIMECMP_BASE_ADDRESS ( MDR_CLINT_TIMER_CMP )

/* Uncomment the line corresponding to the revision of the microcontroller */
//#define MCU_REV1
#define MCU_REV2
...
#define configMINIMAL_STACK_SIZE		( ( uint32_t ) 120 ) /* Can be as low as 60 but some of the demo tasks that use this constant require it to be higher. */
