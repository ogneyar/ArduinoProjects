  /**
  @page ADCUI_uart example readme for MDR32F02 demo board
  @latexonly
  @verbatim
  ...
  * @version V1.0.0
  * @date    14/07/2021
  * @brief   Description of the ADCUI_uart Example.
  ******************************************************************************
...
This example shows, how to collect samples from ADCUI and print them to UART
