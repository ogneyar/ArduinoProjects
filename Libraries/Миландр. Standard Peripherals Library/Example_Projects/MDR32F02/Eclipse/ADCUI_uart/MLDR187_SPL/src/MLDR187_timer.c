...
#define IS_TIMER_PRESCALER(PRESC)	(((PRESC) == 1) || \
									 ((PRESC) == 2) || \
									 ((PRESC) == 4) || \
									 ((PRESC) == 8))
...
#define IS_TIMER_CH_REF_FMT(FMT)	(((FORMAT) == TIM_CHy_CNTRL_OCCM_ALW0) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_1_CCR) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_0_CCR) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_REF) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_ALW1) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_GR_CCR) || \
									 ((FORMAT) == TIM_CHy_CNTRL_OCCM_LESS_CCR))
