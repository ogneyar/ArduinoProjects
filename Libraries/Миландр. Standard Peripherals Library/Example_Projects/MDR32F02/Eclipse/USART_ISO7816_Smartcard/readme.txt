  /**
  @page USART_ISO7816_Smartcard example readme for MDR32F02 demo board
  @latexonly
  @verbatim
  ...
  * @version V1.0.0
  * @date    14/07/2021
  * @brief   Description of the USART_ISO7816_Smartcard Example.
  ******************************************************************************
...
This example shows, how to use USART_ISO7816 interface to communicate with smartcard chip.
The example will request some data from smartcard and send it to UART.

@par Directory contains:

    - MLDR187_SPL							SPL library v0.29
    - src/init.c							common init
    - src/init.h							
...
To launch the example, you must do the following: 
	- Connect card to USART interface:
		VCC -- 3.3V
		GND -- GND
		RST -- PD0
		CLK -- PD12
