...
#define DMA_SSP2_RX						DMA_SSP2_RX_Pos
...
#define DMA_SSP3_RX						DMA_SSP3_RX_Pos
/* TIM4DMAREQ */
...
#define ADC_CFG_DIVCLK_Msk              (0x7U << ADC_CFG_DIVCLK_Pos)            /*!< 0x00007000 */
...
#define ADC_CFG_DIVCLK_2048  			(0xAU << ADC_CFG_DIVCLK_Pos)
/* hardcoded hw selection */
#define ADC_CFG_MAGIC_Pos               (16U)
#define ADC_CFG_MAGIC_Val               0x2
#define ADC_CFG_MAGIC                   (0x2 << ADC_CFG_MAGIC_Pos)
...
#define ADC_STATUS_AWOIF_IE_Msk         (0x1U << ADC_STATUS_AWOIF_IE_Pos)       /*!< 0x00000010 */
#define ADC_STATUS_AWOIF_IE             ADC_STATUS_AWOIF_IE_Msk
...
#define ADC_TRIM_BG_TRIM_Msk            (0xFU << ADC_TRIM_BG_TRIM_Pos)          /*!< 0x0000001E */
