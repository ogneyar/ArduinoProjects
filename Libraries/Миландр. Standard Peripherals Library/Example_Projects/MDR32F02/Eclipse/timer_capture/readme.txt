  /**
  @page timer_capture example readme for MDR32F02 demo board
  @latexonly
  @verbatim
  ...
  * @version V1.0.0
  * @date    14/07/2021
  * @brief   Description of the timer_capture Example.
  ******************************************************************************
...
This example shows, how to use timer's Capture feature to implement frequency and duty-cycle meter 
...
To launch the example, you must do the following: 
    ...
    - Connect PWM signal source to PB6 pin
    - Build and Run the example
    - Check the serial terminal output
