...
const char *ssid = "MyWiFi)"; // "Wi-Fi Summer House"; // 
...
String webPage()
{
  ...
  // -----------заголовок-----------------
  web += "<h1 style'text-align: center;font-family: Open sans;font-weight: 100;font-size: 20px;margin: 0 auto;'>лед онлайн</h1>";
  //-------------------------------------
