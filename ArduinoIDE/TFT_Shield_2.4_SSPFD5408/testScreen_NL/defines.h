...
// ---------------------------------
  ...
  #define write_8(x) { PORT->Group[0].OUTCLR.reg = DMASK; \
      PORT->Group[0].OUTSET.reg = ( ( ( ( (x) & 0x01) ) >> 0 ) << 6) \
                                  |(( ( ( (x) & 0x02) ) >> 1 ) << 7) \
                                  |(( ( ( (x) & 0x04) ) >> 2 ) << 18) \
                                  |(( ( ( (x) & 0x08) ) >> 3 ) << 16) \
                                  |(( ( ( (x) & 0x10) ) >> 4 ) << 8) \
  ...
  #define read_8() ( ( ( (PORT->Group[0].IN.reg >> 6 ) ) << 0 ) & 0x01) \
                  | ( ( ((PORT->Group[0].IN.reg >> 7 ) ) << 1 ) & 0x02) \
                  | ( ( ((PORT->Group[0].IN.reg >> 18) ) << 2 ) & 0x04) \
                  | ( ( ((PORT->Group[0].IN.reg >> 16) ) << 3 ) & 0x08) \
                  | ( ( ((PORT->Group[0].IN.reg >> 8 ) ) << 4 ) & 0x10) \
                  | ( ( ((PORT->Group[0].IN.reg >> 17) ) << 5 ) & 0x20) \
                  | ( ( ((PORT->Group[0].IN.reg >> 20) ) << 6 ) & 0x40) \
                  | ( ( ((PORT->Group[0].IN.reg >> 21) ) << 7 ) & 0x80) ) 
