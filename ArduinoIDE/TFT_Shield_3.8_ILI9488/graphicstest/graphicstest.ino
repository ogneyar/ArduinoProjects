...
void setup(void) {
  ...
  Serial.println(F("Using OPENSMART 3.8\" TFT Arduino Shield Pinout"));
#else
  Serial.println(F("Using OPENSMART 3.8\" TFT Breakout Board Pinout"));
#endif
