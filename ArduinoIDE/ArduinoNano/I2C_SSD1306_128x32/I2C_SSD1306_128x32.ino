...
static const uint8_t ssd1306_128x32_init[] PROGMEM = {
  ...
  // 0xD5, // Настройка частоты обновления дисплея (CLOCKDIV)
  ...
  // 0x81, // Установка яркости дисплея (CONTRAST)
  // 0x8F, // 0x8F..0xCF контраст
  // 0xDB, // Установка уровня VcomH (SETVCOMDETECT)
  ...
  // 0xA8, // Установить multiplex ratio (SETMULTIPLEX)
