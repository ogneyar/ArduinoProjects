...
#define DS_PIN1 2   // Создаем две линии для подключения сенсоров
#define DS_PIN2 10
...
*/
const uint8_t sensor1_address[8] = {0x28, 0x4D, 0x8B, 0x18, 0x00, 0x00, 0x00, 0xBE};
const uint8_t sensor2_address[8] = {0x28, 0x3D, 0x05, 0x17, 0x00, 0x00, 0x00, 0xD5};
