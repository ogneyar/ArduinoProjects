...
#define USE_DAWN 1            // включает/отключает поддержку режима РАССВЕТ на каналах 2, 3, серво1, серво2
#define USE_DRIVE 1           // включает/отключает поддержку линейного привода (в целях экономии памяти)

// =================== СЕРВО ===================
#define SERVO1_RELAY 0        // 1 - заменить серво 1 на реле (ЭКОНОМИТ ПАМЯТЬ). 0 - ничего не делать
#define SERVO2_RELAY 0       // 1 - заменить серво 2 на реле (ЭКОНОМИТ ПАМЯТЬ). 0 - ничего не делать
#define SMOOTH_SERVO 1        // 1 - использовать плавное управление серво, 0 - обычное (ЭКОНОМИТ ПАМЯТЬ)
...
#define THERM2 1            // 1 - термистор на SENS2, 0 - нет
