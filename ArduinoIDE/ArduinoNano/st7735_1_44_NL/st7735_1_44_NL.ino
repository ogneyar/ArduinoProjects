...
void setup(void) {
  ...
  delay(1000);
  st7735_fill(_RED_BLUE, 25, 25, 45, 45);
  
  delay(1000);
  st7735_fill(_BLUE_GREEN, 30, 30, 50, 50);
  
  delay(1000);
  st7735_fill(_RED_GREEN, 35, 35, 55, 55);
  
  delay(1000);
  st7735_fill(_BLUE, 40, 40, 60, 60);
...
void st7735_set_column_and_page(uint8_t caset1, uint8_t caset2, uint8_t raset1, uint8_t raset2)
{
  ...
  st7735_send(LCD_D, caset1); // x1 low   // + shift
  st7735_send(LCD_D, 0x00); // x2 high - конец
  st7735_send(LCD_D, caset2); // x2 low   // 128 horizontal + shift
