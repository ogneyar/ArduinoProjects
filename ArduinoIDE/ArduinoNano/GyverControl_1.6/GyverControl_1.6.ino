...
#define SHOW_INTEGRAL 0       // 1 - показывать график интегральной суммы, 0 - нет
...
// вход SENS2 - цифровой датчик температуры
#define DALLAS_SENS2 1      // 1 - ко входу SENS2 подключен ds18b20, 0 - подключен обычный аналоговый датчик
...
const uint8_t dsAddress[][8] = {
  {0x28,0x4D,0x8B,0x18,0x0,0x0,0x0,0xBE}, // адрес датчика 1
  {0x28,0x3D,0x5,0x17,0x0,0x0,0x0,0xD5},  // адрес датчика 2 (который задымился)
...
#define BETA_COEF2 3950     // температурный коэффициент термистора 2 (см. даташит)
